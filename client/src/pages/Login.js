  ...
  return (
    <>
      <div className=" relative container h-screen max-w-screen-2xl flex-col flex items-center justify-center overflow-clip bg-gradient-to-r from-blue-900 to-orange-500">
        ...
        <div className="z-50 flex absolute bg-emerald-300 justify-center items-center rounded-3xl">
          <div className=" w-3/5">
          ...
          <div className=" transition-transform transform duration-800 scale-100 hover:scale-105">
            <div className="w-2/5 m-5">
              <div className="z-40 h-full bg-emerald-200 rounded-xl shadow-2xl shadow-slate-300 p-4 w-96 m-3">
                ...
                <Form layout="vertical" onFinish={onfinishHandler}>
                  <Form.Item name="email">
                    <Input
                      type="email"
                      placeholder="Email"
                      className="w-full rounded-md border border-stroke bg-white px-3 py-2 text-base text-body-color outline-none focus:border-primary focus-visible:shadow-none dark:border-dark-3 dark:text-black"
                      required
                    />
                  </Form.Item>
                  ...
                  <div className="mb-4">
                    <button
                      className="w-full cursor-pointer rounded-md border border-primary bg-primary px-3 py-2 text-base font-medium text-white transition hover:bg-opacity-90"
                      type="submit"
                    >
                      Login
                    </button>
